...
export class JaxAuth<User> {
  public getUser: (userId: string) => Promise<User> = () => {
    throw new Error('Unimplemented, specify userGetter');
  };
  public getUserHashPasswordField: (user: User) => string = () => {
    throw new Error('Unimplemented, specify getUserHashPasswordField');
  };
  public getUserPasswordSaltField: (user: User) => string = () => '';
  public createRawCookieContents: (user: User) => string = () => {
    throw new Error('Unimplemented, specify createStringifiedCookieContents');
  };
  public createWrongPasswordError: () => Error = () => new Error('Failed Validation');
  public getEncryptionSecret: () => string = () => {
    throw new Error('Must provide an encryption secret');
  };
  public getHMACKey: () => string = () => {
    throw new Error('Must provide an HMACKey');
  };
